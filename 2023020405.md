...
- 1.使用Python求解編碼與解碼問題
  ...
  - 編碼102_Internetwache CTF 2016_The hidden message解答
  - 編碼102:SECCON CTF 2014: Easy Cipher解答
- 2.使用Python求解古典密碼破密分析問題 Crypto102
  - 使用Python求解變形caesar密碼{Crypto102::} 
  - 使用Python求解affine-cipher{Crypto102::}
- 3.使用Python求解PPC(Professional Program Code)問題
  - PPC(Professional Program Code)之使用 nc 遠端連線{PPC101::PPC1_hello world}
  - PPC(Professional Program Code)之pwntools快速入門與示範解題{PPC101::PPC2_3rd}
  - PPC101::PPC3_beautify解答 
  - 【自行完成】自行完成 PPC101::PPC4_count
  - PPC101::PPC5_lambda解答 
  - PPC101::PPC6_money解答
